...
import com.ems.api.dto.request.SearchBoothRequest;
import com.ems.api.dto.request.SearchEventRequest;
import com.ems.api.dto.response.BoothResponse;
...
//    private static final String URL_CREATE = "/booth/create";
//    private static final String URL_SEARCH = "/booth/search";
...
//    private SearchBoothRequest searchBoothRequest;
//
//    @BeforeEach
//    void initData() {
//        searchBoothRequest = SearchBoothRequest.builder().build();
//    }
//
//    @Test
//    void test_search_normalCase_01() throws Exception {
//        MessagesResponse responseBody = MessagesResponse.<SearchResponse<BoothResponse>>builder().build();
...
//                .andExpect(jsonPath("$.status", is(OK.name())))
//                .andExpect(jsonPath("$.result").exists())
//                .andExpect(jsonPath("$.result.id", is(1)))
//                .andExpect(jsonPath("$.result.areaCode", is(areaResponse.getAreaCode())))
//                .andExpect(jsonPath("$.result.areaName", is(areaResponse.getAreaName())))
//                .andExpect(jsonPath("$.result.maxCapacity", is(3000.0)))
//                .andExpect(jsonPath("$.result.availableCapacity", is(3000.0)))
//                .andExpect(jsonPath("$.result.enabled", is(true)))
//                .andExpect(jsonPath("$.result.deleted", is(false)))
//                .andExpect(jsonPath("$.result.areaProductImports").isEmpty())
//                .andExpect(jsonPath("$.result.productDetails").isEmpty());
//
//        verify(areaService, times(1)).create(requestCaptor.capture(), classCaptor.capture());
//        assertThat(requestCaptor.getValue(), samePropertyValuesAs(areaRequest));
//    }
private static final String URL_CREATE = "/event/create";
